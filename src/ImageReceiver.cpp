...
ImageReceiver::ImageReceiver(int port, std::string out_path) :
...
void ImageReceiver::ConnectToNetwork() {
...
void ImageReceiver::ReceiveImageDims() {
...
void ImageReceiver::ReceiveImage(cv::Mat& image) {
...
void ImageReceiver::WriteImage(cv::Mat& image) {
  cv::imwrite(pic_filename_, image);
}

int ImageReceiver::GetWidth() {
  return image_dims_.width;
}

int ImageReceiver::GetHeight() {
